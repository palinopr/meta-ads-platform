-- Add the missing safe_get_campaigns function
...
-- 2. Function to get campaigns safely (THE MISSING PIECE!)
...
-- 3. Function to insert account safely (backup)
...
-- 5. Verify the functions work
SELECT 'Campaign retrieval functions created successfully!' as status;

-- Check if functions exist
SELECT routine_name 
FROM information_schema.routines 
WHERE routine_name IN ('safe_get_campaigns', 'get_current_user_id', 'safe_insert_ad_account')
